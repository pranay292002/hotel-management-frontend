...
const BookingList = () => {
  ...
  return (
    <>
    <div className={`w-[55vw] rounded-xl flex flex-col gap-6 shadow-lg px-[20px] py-[15px] shadow-grey-950 bg-[#FFFFFF]`}>
    ...
    <ul className="flex flex-col gap-y-4">
      {bookings.map((booking:bookingType, key:number ) => (
         <li key={key}  className="flex text-zinc-400 text-[12px] justify-between">
